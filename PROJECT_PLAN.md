...
**Completed phase:** Phase 1 — Project scaffold

**Next phase:** Phase 2 — Establish expected ledger semantics and expected numbers (`not started`)

| Phase | Work | Status |
| ---: | --- | --- |
| 1 | Project scaffold | Complete |
| 2 | Establish expected ledger semantics and expected numbers | Not started / next |
...
Add implementation notes only when work on a phase begins. Phase 2 analysis has not started.
